...
<!--            <li class="dropdown">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="#" onClick="window.open('http://afsirs-online-test.herokuapp.com/SoilMap/?zoom=9', 'Soil Map',width=1200,height=300)"><span class="glyphicon glyphicon-globe"></span> Soil Map</a></li>
                </ul>
            </li>
            <li class="dropdown">

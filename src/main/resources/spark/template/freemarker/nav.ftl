<nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
    ...
    <!--            <li class="dropdown">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/datatools/soilmap/?zoom=9"><span class="glyphicon glyphicon-globe"></span> Soil Map</a></li>
                        <li><a href="/soildata/list"><span class="glyphicon glyphicon-list-alt"></span> Soil Data List </a></li>
                    </ul>
                </li>
                <li class="dropdown">

...
<div class="subcontainer">
    <div class="row">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <label class="form-check-label"><input id="rain_nearest_flg" name="rain_nearest_flg" type="checkbox" value="true"  class="form-check-input" onchange="disableLocSB('rain', this)" <#if permit['et_nearest_flg']?? && permit['et_nearest_flg'] == "true">checked</#if>>&nbsp; &nbsp; Check to use nearest station</label>
            </div>
        </div>
    </div>
    <br><br><br><br>

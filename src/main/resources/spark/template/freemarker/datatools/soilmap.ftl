                        ...
                        <div class="col-sm-2 sidenav">
                            <div id="contentPane2" class="contentPane">
                                ...
                                <p class="text-left">
                                    ...
                                    <br>
                                    &bull; <b>Wait until the polygon drawing process is done</b>, and the soil data table will show up in the left button of page.
                                    <br>
                                    &bull; <b>Enter a name</b> for your data set for future references.
                                    <br>

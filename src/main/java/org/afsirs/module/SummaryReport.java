...
public class SummaryReport {
    ...
    public SummaryReport() {
        ...
        this.totalEvaporationPotential = new ArrayList<Double> ();
        this.peakMonthlyEvaporationPotential = new ArrayList<Double> ();
        
        this.totalEvaporationCrop = new ArrayList<Double> ();
        this.peakMonthlyEvaporationCrop = new ArrayList<Double> ();
